...
1.  Generate a Google Service Account JSON Key for your Google Cloud Project.
    ...
    add a file called `cdp-seattle-21723dcf.json` to it
    (i.e. `.keys/cdp-seattle-21723dcf)`. This file will be used later on.
...
1.  Attach the Pulumi Access Token and the
    ...
    1. Pulumi Access Token -- Create a [new secret](https://github.com/CouncilDataProject/seattle/settings/secrets/actions/new)

    -   Set the name to: **PULUMI_ACCESS_TOKEN**
    -   Set the value to: The token you kept from step #2
    -   Click "Add secret"

    2. Google Service Account JSON -- Create a [new secret](https://github.com/CouncilDataProject/seattle/settings/secrets/actions/new)
...
1.  Once the
    ["Infrastructure" GitHub Action Successfully Completes](https://github.com/CouncilDataProject/seattle/actions?query=workflow%3A%22Infrastructure%22)
...
1.  Once the
    ...
    [Direct Link to Enable](https://console.cloud.google.com/apis/api/speech.googleapis.com/data_logging?project=cdp-seattle-21723dcf)
...
1.  Once the
    ...
    -   Navigate to [Firebase Console](https://console.firebase.google.com),
        login to the Google Account you used during step #2, select the `cdp-seattle-21723dcf` Firebase project
