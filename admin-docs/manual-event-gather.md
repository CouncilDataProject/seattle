...
[Event Gather GitHub Action Page](https://github.com/CouncilDataProject/seattle/actions/workflows/event-gather-pipeline.yml).
...
[Process Special Event GitHub Action Page](https://github.com/CouncilDataProject/seattle/actions/workflows/process-special-event.yml).
